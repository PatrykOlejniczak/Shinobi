...
col_used = [ce.id, ce.category_id, ce.city_id, ce.user_id, ce.paidads_id_index, ce.has_phone, ce.has_person, ce.predict_sold, ce.title, ce.description, ce.photo_sizes]
col_used_test = [ce.id, ce.category_id, ce.city_id, ce.user_id, ce.paidads_id_index, ce.has_phone, ce.has_person, ce.title, ce.description, ce.photo_sizes]

print "Reading CSV files..."
#X_train, Y_train = read_csv(file_name)
X_train, Y_train = base_predict_helper.read_csv_dir(data_dir=base_predict_helper.data_dir, cols=col_used, predict_col_name='predict_sold', first_n_files=12, skip_n_first_files=5)
